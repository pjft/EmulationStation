...
SystemData::~SystemData()
{
	...
	if (mIsCollectionSystem) {
		...
		CollectionSystemManager::get()->saveCustomCollection(this);
	}
	else if(!Settings::getInstance()->getBool("IgnoreGamelist") && Settings::getInstance()->getBool("SaveGamelistsOnExit"))
	{
		updateGamelist(this);
	}
